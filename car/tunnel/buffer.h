...
int8_t between  ( list * lst, char * item, node * r, node * element) ;  /*adds node with this*/
int8_t enqueue ( list * lst, const char * item) ;    /* alias to enqueue task with between function */
...
#define PREFIX 512 /* this is string's max length*/
